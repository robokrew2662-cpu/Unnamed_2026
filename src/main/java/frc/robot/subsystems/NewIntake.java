...
public class IntakeSubsystem extends SubsystemBase {
  ...
  private FlyWheel flyWheelintake = new FlyWheel(intakeConfig);
   ...
   */
  public AngularVelocity getVelocity() {return flyWheelintake.getSpeed();}
   ...
   */
  public Command setVelocity(AngularVelocity speed) {return flyWheelintake.setSpeed(speed);}
  ...
  public void periodic() {
   ...
   flyWheelintake.updateTelemetry();
  }

  @Override
  public void simulationPeriodic() {
    // This method will be called once per scheduler run during simulation
  flyWheelintake.simIterate();
  }
}
